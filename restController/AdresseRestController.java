...
public class AdresseRestController {
	...
	@DeleteMapping("/adressex/{id}")
	public ResponseEntity<Long> save(@PathVariable Long id) {
		
		return new ResponseEntity<Long>(adresseService.delete(id), HttpStatus.OK);
	}
